...
def clear():
    ...
    equation_label.set("")  # Clears the label text
    equation_text=""
...
button10 = Button(frame, text=0, height=4, width=9, command=lambda: button_press(0))
...
# Clear button (used grid instead of pack)
clear_button = Button(window, text='Clear', height=4, width=12, font=35, command=clear)
clear_button.pack()  # Use pack for the clear button (or grid depending on layout needs)
